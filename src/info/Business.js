...
const text = `를 이니셜을 모티브로 하여 (주)동우개발 전 직원들이 고객을 향해 친절하게 인사하는 모습을 형상화 한 것이며, 고객 서비스를 최고의 기업 가치로 생각하는 (주)동우개발의 의지를 담아낸 CI 입니다.`
    ...
    <div className={styles.main_container}>
      <Grid container>
        ...
        <Grid item xs={12} sm={4} md={5}className={styles.image_container}>
          <img src="/logo-black.png" alt="logo" className={styles.image}/>
        </Grid>

        <Grid item xs={12} sm={7} md={5}>
          <p className={styles.ci_content}>
            <strong>
