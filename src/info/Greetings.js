...
const text = `이와 같은 목적을 달성하기 위해서는 회사의 이익도 중요하지만
    ...
    <Grid container className={styles.main_container}>
      <Grid item xs={12} sm={4}>
        <div className={styles.image_container}>
          <img src="https://cdn.imweb.me/thumbnail/20220721/d57f018ea93e2.png" />
        </div>
      ...
      <Grid item xs={12} sm={8} className={styles.right_container}>
        ...
        <div className={styles.content_container}>
          <h3>안녕하십니까<br /> 주식회사 동우개발 <strong>회장 이육행 </strong>입니다.</h3>
          <p>{text}</p>
