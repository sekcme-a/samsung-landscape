      ...
      >
        <SwiperSlide>
          <div
            ...
            style={{ backgroundImage: `url(${data.main.banner_bg1})` }}
          >
            <EditButton
              type="main"
              item="banner_bg1"
              text="배경이미지 삽입"
              mode="image"
              defaultImg="/images/main-banner1.jpg"
        ...
        <SwiperSlide>
          <div
            className="main-banner"
            style={{ backgroundImage: `url(${data.main.banner_bg2})` }}
          >
            <EditButton
              type="main"
              item="banner_bg2"
              text="배경이미지 삽입"
              mode="image"
              defaultImg="/images/main-banner2.jpg"
              style={{ position: "absolute", top: 150, right: 100 }}
            />
            <div className="d-table">
              <div className="d-table-cell">
